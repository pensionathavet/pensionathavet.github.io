...
jQuery(document).ready(function($) {
    ...
    $('#area_main').magnificPopup({
        items: [
            {
                src: 'images/areas/main/1.jpg'
            },
            {
                src: 'images/areas/main/2.jpg'
            },
            {
                src: 'images/areas/main/3.jpg'
            },
            {
    ...
    $('#area_side').magnificPopup({
        items: [
            {
                src: 'images/areas/side/1.jpg'
            },
            {
    ...
    $('#area_wc').magnificPopup({
        items: [
            {
                src: 'images/areas/wc/1.jpg'
            },
            {
                src: 'images/areas/wc/2.jpg'
            },
            {
                src: 'images/areas/wc/3.jpg'
            },
            {
                src: 'images/areas/wc/4.jpg'
            },
            {
                src: 'images/areas/wc/5.jpg'
            }
        ],
        gallery: {
            enabled: true
